package com.burkido.run.presentation.activerun.service
...
class ActiveRunService : Service() {
    ...
    private val baseNotification by lazy {
        NotificationCompat.Builder(applicationContext, CHANNEL_ID)
            .setSmallIcon(com.burkido.core.presentation.designsystem.R.drawable.logo)
    ...
    private fun start(activityClass: Class<*>) {
        if (!isServiceActive) {
            ...
            val activityIntent = Intent(applicationContext, activityClass).apply {
                data = "runiqueclone://active_run".toUri()
    ...
    companion object {
        private const val CHANNEL_ID = "ActiveRunService"

        private val ACTION_START = "ACTION_START"
        private val ACTION_STOP = "ACTION_STOP"

        private val EXTRA_ACTIVITY_CLASS = "EXTRA_ACTIVITY_CLASS"
